...
window = Tk()
window.title('Onion Clicker v2.4')
window.geometry('550x800')
window.iconbitmap('cache/onions/icon.ico')
window.config(bg = '#ff8400')
window.resizable(0, 0)

photo1 = Image.open('cache/onions/onion.png')
photo2 = Image.open('cache/buttons/hint.png')
photo3 = Image.open('cache/buttons/sklep.png')
photo4 = Image.open('cache/buttons/minigry.png')
...
if 'TIER : BRONZE\n' in fileread:
	photo = Image.open('cache/onions/onionbronze.png')
...
if 'TIER : SILVER\n' in fileread:
	photo = Image.open('cache/onions/onionsilver.png')
	image = photo.resize((250, 250))
	newimg = ImageTk.PhotoImage(image)
...
if 'TIER : GOLD\n' in fileread:
	photo = Image.open('cache/onions/oniongold.png')
	image = photo.resize((250, 250))
	newimg = ImageTk.PhotoImage(image)
...
if 'TIER : DIAMOND\n' in fileread:
	photo = Image.open('cache/onions/oniondiamond.png')
	image = photo.resize((250, 250))
	newimg = ImageTk.PhotoImage(image)
