...
def x2():
    ...
    if 'MONEY : x2\n' in fileread:
        ...
        if int(liczba) >= 500:
            ...
            licznik = Label(window, text = f'KASA:{liczba}$', bg = '#ff8400', font = ('jetbrains mono bold', 30))
            licznik.pack(side = TOP)
            messagebox.showinfo('Onion Clicker', 'Zakupiłeś ULEPSZENIE (KASA x2)')
...
def x3():
    ...
    if 'MONEY : x3\n' in fileread:
        ...
        if int(liczba) >= 7000:
            ...
            licznik = Label(window, text = f'KASA:{liczba}$', bg = '#ff8400', font = ('jetbrains mono bold', 30))
            licznik.pack(side = TOP)
            messagebox.showinfo('Onion Clicker', 'Zakupiłeś ULEPSZENIE (KASA x3)')
...
def x5():
    ...
    if 'MONEY : x5\n' in fileread:
        ...
        if int(liczba) >= 10000:
            ...
            licznik = Label(window, text = f'KASA:{liczba}$', bg = '#ff8400', font = ('jetbrains mono bold', 30))
            licznik.pack(side = TOP)
            messagebox.showinfo('Onion Clicker', 'Zakupiłeś ULEPSZENIE (KASA x5)')
...
def tierbronze():
    ...
    if 'TIER : BRONZE\n' in fileread:
        ...
        if int(liczba) >= 700:
            ...
            licznik = Label(window, text = f'KASA:{liczba}$', bg = '#ff8400', font = ('jetbrains mono bold', 30))
            licznik.pack(side = TOP)
            messagebox.showinfo('Onion Clicker', 'Zakupiłeś TIER BRONZE\nZwrócono 350$')
...
def tiersilver():
    ...
    if 'TIER : SILVER\n' in fileread:
        ...
        if int(liczba) >= 5000:
            ...
            licznik = Label(window, text = f'KASA:{liczba}$', bg = '#ff8400', font = ('jetbrains mono bold', 30))
            licznik.pack(side = TOP)
            messagebox.showinfo('Onion Clicker', 'Zakupiłeś TIER SILVER\nZwrócono 500$')
...
def tiergold():
    ...
    if 'TIER : GOLD\n' in fileread:
        ...
        if int(liczba) >= 15000:
            ...
            licznik = Label(window, text = f'KASA:{liczba}$', bg = '#ff8400', font = ('jetbrains mono bold', 30))
            licznik.pack(side = TOP) 
            messagebox.showinfo('Onion Clicker', 'Zakupiłeś TIER GOLD\nZwrócono 4,000$')
...
def tierdiamond():
    ...
    if 'TIER : DIAMOND\n' in fileread:
        ...
        if int(liczba) >= 30000:
            ...
            licznik = Label(window, text = f'KASA:{liczba}$', bg = '#ff8400', font = ('jetbrains mono bold', 30))
            licznik.pack(side = TOP)
            messagebox.showinfo('Onion Clicker', 'Zakupiłeś TIER DIAMOND\nZwrócono 6,000$')
...
def append():
    global helproot
    copy = 'F1 - lista skrótów\nF7 - konsola\nF8 - zapis gry\nESC - wyjście'
    helproot.clipboard_append(copy)
    messagebox.showinfo('Onion Clicker', 'SKOPIOWANO LISTĘ SKRÓTÓW DO SCHOWKA')
...
def helpevent(event):
    ...
    if event:
        if helproot is None:
            ...
            helproot.geometry('400x250')
            helproot.grab_set()
            label = Label(helproot, text = 'Skróty klawiszowe:', font = ('jetbrains mono bold', 20, 'underline'), bg = '#ff8400')
            label.pack(side = TOP)
            shortcuts = Label(helproot, text = 'F1 - lista skrótów\nF7 - konsola\nF8 - zapis gry\nESC - wyjście\n', font = ('jetbrains mono bold', 17), bg = '#ff8400')
            shortcuts.pack()
            button = Button(helproot, text = 'SKOPIUJ LISTĘ SKRÓTÓW', font = ('jetbrains mono extrabold', 15), bg = '#ff8400', activebackground = '#ff8400', command = append, relief = SOLID)
            button.pack()
            helproot.protocol('WM_DELETE_WINDOW', helpeventdestroy)
            helproot.mainloop()
        else:
            pass